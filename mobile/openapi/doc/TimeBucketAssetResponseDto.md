...
------------ | ------------- | ------------- | -------------
**city** | **List<String>** | Array of city names extracted from EXIF GPS data | [default to const []]
**country** | **List<String>** | Array of country names extracted from EXIF GPS data | [default to const []]
...
**latitude** | **List<num>** | Array of latitude coordinates extracted from EXIF GPS data | [optional] [default to const []]
...
**longitude** | **List<num>** | Array of longitude coordinates extracted from EXIF GPS data | [optional] [default to const []]
...
**stack** | [**List<List<String>>**](List.md) | Array of stack information as [stackId, assetCount] tuples (null for non-stacked assets) | [optional] [default to const []]
