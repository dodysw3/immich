# openapi.model.PersonAssetsResponseDtoAssetsInner
...
**duplicateId** | **String** | Duplicate group ID | [optional] 
...
**libraryId** | **String** | Library ID | [optional] 
...
**originalMimeType** | **String** | Original MIME type | [optional] 
**originalPath** | **String** | Original file path | 
**owner** | [**UserResponseDto**](UserResponseDto.md) |  | [optional] 
**ownerId** | **String** | Owner user ID | 
**people** | [**List<PersonResponseDto>**](PersonResponseDto.md) |  | [optional] [default to const []]
**recognizedAt** | [**DateTime**](DateTime.md) | When the face was matched to this person | 
