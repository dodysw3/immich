...
// tests for PersonAssetsResponseDtoAssetsInner
void main() {
  // final instance = PersonAssetsResponseDtoAssetsInner();

  group('test PersonAssetsResponseDtoAssetsInner', () {
    ...
    test('to test the property `recognizedAt`', () async {
      // TODO
    });
