...
void main() {
  ...
  group('tests for AssetsApi', () {
    ...
    //
    //Future reportFailure(String id, ExternalOcrFailureDto externalOcrFailureDto) async
    test('test reportFailure', () async {
      // TODO
    });
    ...
    //
    //Future<AssetMediaResponseDto> uploadAsset(MultipartFile assetData, int duration, DateTime fileCreatedAt, DateTime fileModifiedAt, { String key, String slug, String xImmichChecksum, String filename, bool isFavorite, String livePhotoVideoId, List<AssetMetadataUpsertItemDto> metadata, MultipartFile sidecarData, AssetVisibility visibility }) async
    ...
    //
    //Future<ExternalOcrWriteResponseDto> writeResult(String id, ExternalOcrResultDto externalOcrResultDto) async
    test('test writeResult', () async {
      // TODO
    });
