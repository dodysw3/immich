...
// tests for FacialRecognitionConfig
void main() {
  // final instance = FacialRecognitionConfig();

  group('test FacialRecognitionConfig', () {
    ...
    // FaceDetectionTilingConfig tiling
    test('to test the property `tiling`', () async {
      // TODO
    });
